Public Class Form1
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        Label2.Text = IIf(timelimit * 10 - counter > 0, Format(timelimit - counter / 10, "0.0"), Format(0, "0.0"))
        If counter >= timelimit * 10 Then
            Timer1.Stop()
            Label1.Visible = False
            If Convert.ToString(InputBox("Please enter the number!")) = Label1.Text Then
                MsgBox("Right!")
            Else
                MsgBox("Wrong!")
            End If
